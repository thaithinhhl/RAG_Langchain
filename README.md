...
Kiểm tra xung đột cổng: Nếu port 8000 đã bị sử dụng bởi ứng dụng khác, hãy thử dùng port khác:

python deploy.py --api-port 8080 --ui-port 7070
Kiểm tra URL API trong Gradio UI: Hãy chắc chắn URL API đã được cấu hình đúng trong biến môi trường:
